...
namespace 相机截图功能
{
    ...
    public class ScreenCaptureEditor : EditorWindow
    {
        ...
        /// 这个是放在桌面
        /// </summary>
        private static string directory =  $"{Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory)}/ScreenCaptureEditor/";
        ...
        [MenuItem("Tools/截图/打开窗口 &`", false, 0)]
        public static void ShowWindow()
        {
            GetWindow(typeof(ScreenCaptureEditor));
        }

        [MenuItem("Tools/截图/存储路径 &2", false, 2)]
        ...
        [MenuItem("Tools/截图/单张截图 &1", false, 1)]
