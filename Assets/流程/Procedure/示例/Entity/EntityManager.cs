    ...
    public partial class EntityManager : GameModuleBase<EntityManager>
    {
        ...
        public Entity Allocate(int id, string key, IEntityData entityData, Vector3 pos, Quaternion quaternion, Transform parent)
        {
            ...
            if (m_EntityDic.ContainsKey(id))
            {
                ...
                Debug.LogError($"[EntityError] id is already occupied.  Entity {e.ToString()}");
            }
        ...
        public bool Recycle(Entity entity)
        {
            if (entity != null)
            {
                ...
                {
                    Debug.LogError("[Entity] this entity is not created by manager");
                }
            }
            return false;
        }
        ...
        private EntityContainer GetContainer(string containerName)
        {
            ...
            {
                Debug.LogError($"[EntityError] There is no entity container named {containerName}");
                return null;
            }
        }
        ...
        public Entity GetEntity(int entityId)
        {
            ...
            {
                Debug.LogError($"[Entity] There is no entity with an id of {entityId}");
                return null;
            }
        }
        ...
        public void Clean(string containerName, int count)
        {
            ...
            {
                Debug.LogError("[EntityContainer] null container");
            }
        }
