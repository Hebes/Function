...
//     #region 迷你对象池
//
//     private List<K> BagItemPoolList { get; set; } = new List<K>(200);
//
//     /// <summary>
//     /// 从对象池获取
//     /// </summary>
//     private K Get(K value)
//     {
//         K k = BagItemPoolList[0];
//         if (k==null)
//         {
//             
//             //GameObject
...
//             //重置位置
//             bagItem.transform.localPosition = new Vector3((index % col) * itemW, -index / col * itemH, 0);
//             //更新格子信息
//             bagItem.GetComponent<K>().InitInfo(items[index]);
//
//             //判断有没有这个坑
//             if (nowShowItems.ContainsKey(index))
//                 nowShowItems[index] = bagItem.gameObject;
//             else
